...
NPY_NO_EXPORT void
FLOAT_frexp_avx512_skx(char **args, npy_intp const *dimensions, npy_intp const *steps, void *func)
{
    if (!run_unary_two_out_avx512_skx_frexp_FLOAT(args, dimensions, steps)) {
        FLOAT_frexp(args, dimensions, steps, func);
    }
}
...
NPY_NO_EXPORT void
FLOAT_ldexp_avx512_skx(char **args, const npy_intp *dimensions, const npy_intp *steps, void *func)
{
    if (!run_binary_avx512_skx_ldexp_FLOAT(args, dimensions, steps)) {
        FLOAT_ldexp(args, dimensions, steps, func);
    }
}
...
NPY_NO_EXPORT void
DOUBLE_frexp_avx512_skx(char **args, npy_intp const *dimensions, npy_intp const *steps, void *func)
{
    if (!run_unary_two_out_avx512_skx_frexp_DOUBLE(args, dimensions, steps)) {
        DOUBLE_frexp(args, dimensions, steps, func);
    }
}
...
NPY_NO_EXPORT void
DOUBLE_ldexp_avx512_skx(char **args, const npy_intp *dimensions, const npy_intp *steps, void *func)
{
    if (!run_binary_avx512_skx_ldexp_DOUBLE(args, dimensions, steps)) {
        DOUBLE_ldexp(args, dimensions, steps, func);
    }
}
...
NPY_NO_EXPORT void
LONGDOUBLE_frexp_avx512_skx(char **args, npy_intp const *dimensions, npy_intp const *steps, void *func)
{
    if (!run_unary_two_out_avx512_skx_frexp_LONGDOUBLE(args, dimensions, steps)) {
        LONGDOUBLE_frexp(args, dimensions, steps, func);
    }
}
...
NPY_NO_EXPORT void
LONGDOUBLE_ldexp_avx512_skx(char **args, const npy_intp *dimensions, const npy_intp *steps, void *func)
{
    if (!run_binary_avx512_skx_ldexp_LONGDOUBLE(args, dimensions, steps)) {
        LONGDOUBLE_ldexp(args, dimensions, steps, func);
    }
}
