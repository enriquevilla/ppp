...
InitOperators(PyObject *dictionary) {
    ...
    if (NPY_CPU_HAVE(AVX512_SKX)) {
        frexp_functions[1] = FLOAT_frexp_avx512_skx;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX512_SKX
    if (NPY_CPU_HAVE(AVX512_SKX)) {
        frexp_functions[2] = DOUBLE_frexp_avx512_skx;
    }
    #endif
    ...
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX512_SKX
    if (NPY_CPU_HAVE(AVX512_SKX)) {
        ldexp_functions[1] = FLOAT_ldexp_avx512_skx;
    }
    #endif
    
    #ifdef HAVE_ATTRIBUTE_TARGET_AVX512_SKX
    if (NPY_CPU_HAVE(AVX512_SKX)) {
        ldexp_functions[4] = DOUBLE_ldexp_avx512_skx;
    }
    #endif
